...
CLASSIFICATION_ROOT = pc.data_root_dir.joinpath(
    "FruitsAndVegetablesImageRecognitionDataset"
)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Parse FruitsAndVegetablesImageRecognitionDataset dataset"
    )
    parser.add_argument(
        "-f",
        dest="force",
    ...
    target_parquet_file = pc.data_root_dir.joinpath(
        "FruitsAndVegetablesImageRecognitionDataset.parquet"
    )
