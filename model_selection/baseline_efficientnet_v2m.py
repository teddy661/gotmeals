...
def main():
    ...
    joblib.dump(
        class_list, f"class_list_{MODEL_NAME}.lzma", compress=3, protocol=pickle.HIGHEST_PROTOCOL
    )
    ...
    with mirrored_strategy.scope():
        ...
        x = Dense(512, activation="relu", kernel_initializer=initializers.HeNormal())(
            x
        )
